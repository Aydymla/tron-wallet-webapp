...
async def open_webapp(message: types.Message):
    webapp_url = "https://aydymla.github.io/tron-wallet-webapp/"
    keyboard = InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🌐 Открыть WebApp", web_app=types.WebAppInfo(url=webapp_url))]
        ]
    )
    await message.answer("Откройте WebApp кошелёк:", reply_markup=keyboard)
